...
/**
 * Tests the DrawableGraphRequestEvent.
 *
 * @author Till Heistermann <till.heistermann@student.kit.edu>
 */
public class DrawableGraphRequestEventTest {
    ...
    public void testNullParameter() {
        DrawableGraphRequestEvent event =
            new DrawableGraphRequestEvent(null);
        assertNull(event.getDrawableGraphSpecification());
    }
}
